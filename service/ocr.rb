...
module OpticalReader
  module Service
    ...
    class OCR
      ...
      RTL_LANGS = %W[ara heb syr kur pus urd yid]

      # no use-case for this now. i18n.t('ocr_langs') currently.
      ...
      def validate_params path, lang
        raise ArgumentError.new 'Please supply a path for the document image.' if path.nil?
