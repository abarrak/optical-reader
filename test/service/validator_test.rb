  ...
  module ServiceTest
    ...
    class ValidatorTest < Minitest::Test
      ...
      def setup
        ...
        @real_img = File.open File.expand_path("test-images/sample-eng.png", File.dirname(__FILE__))
      end
      ...
      def test_validate_scan_input
        ...
        doc[:tempfile] = File.open File.expand_path("test-images/large.png", File.dirname(__FILE__))
